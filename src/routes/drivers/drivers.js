...
export const getDriversByQueries = async (queries) => {
  try {
    ...
    let sql1 = `SELECT IDDriver as driverId, Name as name, Lastname as lastname, IdentificationCode as identificationCode, Photo as photo, Email as email, CreatedAt as createdAt FROM driver`; /* prettier-ignore */
